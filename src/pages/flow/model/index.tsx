    ...
    },
    {
      ...
      render: (text, record: TableListItem) => (
        <Fragment>
          <MyAuthorized
            authorizedType="a"
            authority={['/flow/model/edit', '/flow/model/update']}
            onClick={() => history.push(`/flow/model/edit/${record.id}`)}
            title="编辑"
            divider
          />
          ...
          <div className={styles.tableList}>
            ...
            <div className={styles.tableListOperator}>
              <Button
                disabled={loading}
                icon={<PlusOutlined />}
                onClick={() => history.push('/flow/model/add')}
                type="primary"
              >
                新建
              </Button>
...
export default connect(
  ({
    ...
    model,
    loading:
      loading.effects['model/list'] ||
      loading.effects['model/disabled'] ||
      loading.effects['model/enabled'] ||
      loading.effects['model/reset'] ||
      loading.effects['model/save'] ||
      loading.effects['model/update'],
  }),
)(TableList);
